...
const HomeFeaturedSections = () => {
  return (
    <section className="mx-6 mb-30 md:mx-10 lg:mx-auto lg:mb-50 lg:max-w-277.5">
      <div className="relative overflow-hidden rounded-lg bg-brand px-6 py-13.75 text-center md:px-14.5 md:pb-16 md:pt-13 lg:min-h-140 lg:px-23.75 lg:pt-0 lg:text-left">
        ...
        <div className="relative z-10 mx-auto mb-8 w-43 md:mb-16 md:w-49.25 lg:absolute lg:bottom-0 lg:left-23.75 lg:mb-0 lg:w-102.5">
          <ResponsivePicture
        ...
        <div className="relative z-10 lg:ml-auto lg:flex lg:min-h-140 lg:w-87.25 lg:items-center">
          <div>
            <h2 className="mx-auto mb-6 max-w-70 text-display leading-10 font-bold uppercase tracking-heading text-white md:max-w-none md:text-hero md:leading-14.5 md:tracking-banner lg:mx-0">
              ZX9
              <br />
              Speaker
            </h2>
      ...
      <div className="relative mt-6 overflow-hidden rounded-lg bg-surface px-6 py-25.25 md:mt-8 md:px-15.5 lg:mt-12 lg:px-23.75">
        <ResponsivePicture
      ...
      <div className="mt-6 grid gap-6 md:mt-8 md:grid-cols-2 md:gap-2.75 lg:mt-12 lg:gap-7.5">
        ...
        <div className="rounded-lg bg-surface px-6 py-10.25 md:px-10.25 md:py-25.25 lg:px-23.75">
          <h2 className="mb-8 text-heading-md leading-heading font-bold uppercase tracking-banner text-black">
            YX1 Earphones
          </h2>
